...
const $local = false, $back = false, $dom = {
    ...
    pttlengthInputElementElement: $('#pttlengthInputElement')
};
...
const $propEvent = {
    async didReceiveSettings(data) {
        ...
        $dom.pttlengthInputElementElement.value = $settings.selectedPTT || 0;
    },
...
$dom.pttlengthInputElementElement.addEventListener('input', function () {
    console.log('Step Length:', $dom.pttlengthInputElementElement.value);
    $settings.selectedPTT = Number($dom.pttlengthInputElementElement.value);
});