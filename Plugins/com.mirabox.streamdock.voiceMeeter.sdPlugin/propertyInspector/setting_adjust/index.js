...
const $propEvent = {
    ...
    didReceiveSettings(data) {
        $dom.strip_num.value = $settings.strip_num;
        $dom.setting.value = $settings.setting;
...
$dom.strip_num.addEventListener('change', function () {
    $settings.strip_num = parseInt(this.value);
});

$dom.setting.addEventListener('change', function () {
