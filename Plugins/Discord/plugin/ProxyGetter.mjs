...
import os from "os";
/**
 * 获取系统代理地址（http://host:port 或 https://host:port）
 * 无代理时返回 null
 */
...
export default function startAutoRefreshProxy(intervalMs = 5000) {
    ...
    function update() {
        try {
            ...
            if (temp != currentProxy) {
                currentProxy = temp;
                if (temp != null) {
                    const agent = new ProxyAgent(temp);
